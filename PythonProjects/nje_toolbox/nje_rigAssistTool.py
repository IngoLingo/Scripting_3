...
class RigAssistUI():
    def __init__(self):
        self.my_window = "njeRigAssistWindow"
    ...
    def create(self):
        ...
        # Position
        cmds.text(label='Old Side Indicator')
        self.sideOld_string = cmds.textField(parent=self.col_layout, insertText="L")
        cmds.text(label='New Side Indicator')
        self.sideNew_string = cmds.textField(parent=self.col_layout, insertText="R")
    ...
    def buildFKIK(self):
        nameString = cmds.textField(self.sideOld_string, q=True, text=True)
        print nameString
